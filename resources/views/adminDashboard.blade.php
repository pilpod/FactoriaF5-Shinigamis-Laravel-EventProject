    ...
    <div class="w-full sm:px-6">
        ...
        <section style="margin-top: 20px;">
            ...
            <div class="flex flex-col">
                ...
                <span id="btnCreateEvent" class="block py-5 text-2xl"><a href="{{route('createEvent')}}"><i class="fas fa-plus-square"></i> Create Event</a></span>
                </div>
                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    ...
                    <table class="table-fixed min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="w-1/6 px-6 py-3 bg-gray-50 text-right text-base font-medium text-gray-500 uppercase tracking-wider">
                            Options
                            </th>
                        </tr>
                        </thead>
