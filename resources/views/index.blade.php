						...
						<!-- <div class="slider">
							@foreach($outstanding as $item)
								<div class="slide" id="slide">
									<p>{{$item->title}}</p>
									<img src="{{$item->picture_path}}" class="img" alt="">
						...
						<!--Slide 1-->
							...
							<div class="carousel-item absolute opacity-0" style="height:50vh;">
								<div class="block h-full w-full bg-orange-500 text-white text-5xl text-center">
									<p>{{$outstanding[1]->title}}</p>
									<img src="{{$outstanding[1]->picture_path}}" class="object-cover" alt="">
								</div>
							</div>
							...
							<div class="carousel-item absolute opacity-0" style="height:50vh;">
								<div class="block h-full w-full bg-green-500 text-white text-5xl text-center">
									<p>{{$outstanding[2]->title}}</p>
									<img src="{{$outstanding[2]->picture_path}}" class="object-cover" alt="">
								</div>
							</div>
